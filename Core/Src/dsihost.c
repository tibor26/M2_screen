...
void MX_DSIHOST_DSI_Init(void)
{
  ...
  VidCfg.NullPacketSize = 4;
  VidCfg.HSPolarity = DSI_HSYNC_ACTIVE_HIGH;
  VidCfg.VSPolarity = DSI_VSYNC_ACTIVE_HIGH;
  VidCfg.DEPolarity = DSI_DATA_ENABLE_ACTIVE_HIGH;
  VidCfg.HorizontalSyncActive = 4;
  VidCfg.HorizontalBackPorch = 8;
  VidCfg.HorizontalLine = 1300;
  VidCfg.VerticalSyncActive = 2;
  VidCfg.VerticalBackPorch = 4;
  VidCfg.VerticalFrontPorch = 4;
  VidCfg.VerticalActive = 402;
...
void HAL_DSI_MspInit(DSI_HandleTypeDef* dsiHandle)
{
  ...
  */
    ...
    PeriphClkInit.PLL3.PLL3N = 100;
    PeriphClkInit.PLL3.PLL3P = 8;
    PeriphClkInit.PLL3.PLL3Q = 2;
    PeriphClkInit.PLL3.PLL3R = 83;
